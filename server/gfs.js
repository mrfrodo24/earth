 ...
 * 11-29   00    000   003   006   009   012   015   018   021   024 ...
 * 11-29   06                000   003   006   009   012   015   018   021   024 ...
 * 11-29   12                            000   003   006   009   012   015   018   021   024 ...
 * 11-29   18                                        000   003   006   009   012   015   018   021   024 ...
 * 11-30   00                                                    000   003   006   009   012   015   018   021   024 ...
 *
...
exports.product = function(type, cycle, forecastHour) {
    return {
        ...
        file: function() {
            ...
            var ff = tool.pad(forecastHour, 3);
            switch (type) {
                case "0.5":    return util.format("gfs.t%sz.pgrb2.0p50.f%s", cc, ff);
                case "0.5b":   return util.format("gfs.t%sz.pgrb2b.0p50f%s", cc, ff);
                case "1.0":    return util.format("gfs.t%sz.pgrb2.1p00.f%s", cc, ff);
