/**
 * scales - sets the bounds and color scale for a product.
 *
 * Copyright (c) 2018 Spencer Rhodes
 * The MIT License - http://opensource.org/licenses/MIT
 *
 * https://github.com/mrfrodo24/weather-flow
 */
var scales = function() {
    "use strict";
    var me = this;
     ...
     * @param {string} the layer level
     * @param {object} a 2-element array with the min and max values in the layer
     * @return {object} the gradient and bounds
     */
    function geopotential(surface, level) {
        if (surface !== "isobaric") {
    ...
    function convertColorsTo256(gradient) {
        if (typeof gradient !== 'object' || gradient.length === 0 || gradient[0].length < 2)
            return [];
        if (typeof gradient[0][1] === 'object') {
            // Gradient definition already has values in 1st position, with the RGB values in the second column
            for (var i = gradient.length - 1; i >= 0; i--) {
                gradient[i][1][0] *= 255;
                gradient[i][1][1] *= 255;
                gradient[i][1][2] *= 255;
